% SCENARIO 3: Control twice the area but half the effort for 50 years
clear all
...
[t_vec, C_y_f, N_y_2, N_y_1, N_y_0] = simulate_reefs_v2(num_reefs, t_end, params, initial_state, control_effort_s3);

% Calculate coral cover and cots over time
coral_s3 = sum(C_y_f, 1);
starfish_age2_s3 = sum(N_y_2, 1);
starfish_age1_s3 = sum(N_y_1, 1);
starfish_larvae_s3 = sum(N_y_0, 1);
...
plot(t_vec, coral_s3, 'Linewidth', 2)
xlabel('Time (years)')
